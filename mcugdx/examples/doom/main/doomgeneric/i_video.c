...
void I_InitGraphics(void) {
	...
	printf("I_InitGraphics: framebuffer: x_res: %li, y_res: %li, x_virtual: %li, y_virtual: %li, bpp: %li\n",
		   s_Fb.xres, s_Fb.yres, s_Fb.xres_virtual, s_Fb.yres_virtual, s_Fb.bits_per_pixel);

	printf("I_InitGraphics: framebuffer: RGBA: %li%li%li%li, red_off: %li, green_off: %li, blue_off: %li, transp_off: %li\n",
...
void I_SetPalette(byte *palette) {
	...
	for (i = 0; i < 256; ++i) {
		...
		// Store the RGB565 color directly
		colors[i] = swap_bytes(rgb565);
	}
