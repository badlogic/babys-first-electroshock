...
void webserver_init(void) {
    ...
    mcugdx_prefs_init();
    const char *ssid = mcugdx_prefs_read_string("window-opener", "ssid");
    const char *password = mcugdx_prefs_read_string("window-opener", "password");
